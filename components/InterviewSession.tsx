    ...
    <div className="relative w-full h-full flex flex-col bg-gray-900">
      <div className="flex-1 relative flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div
            className={`relative w-40 h-40 sm:w-56 sm:h-56 rounded-full border-4 shadow-2xl overflow-hidden transition-all duration-300 ${
              isAiSpeaking ? 'border-emerald-500 speaking-ring' : 'border-gray-700'
            }`}
          >
            <img src={AVATAR_URL} alt="Beatrice HR" className="w-full h-full object-cover" />
          </div>
          <div className="mt-6 text-center bg-black/40 backdrop-blur-md px-6 py-3 rounded-xl border border-white/10 shadow-xl">
            ...
            {status === 'connecting' && (
              <p className="text-gray-300 text-sm mt-2 animate-pulse">Connecting secure line...</p>
            )}
          </div>
        </div>
